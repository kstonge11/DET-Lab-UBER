# DET Lab UBER Cover Sheet Tool

A PyQt6 desktop application for HP printer validation testing. This tool streamlines the process of logging print errors and generating cover sheets for defect tracking during DET UBER (Design Evaluation Testing) lab sessions.

## Overview

The DET Lab UBER Cover Sheet Tool allows test technicians to:
...
### Test Info Panel
- **Printer Selection**: Switch between 3 printer units (TH5BA1L009 - TH5BA1L011)
