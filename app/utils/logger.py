"""
Debug logging for DET Lab UBER Tool.
...
LOG_DIR = Path.home() / ".det_lab_uber_logs"
LOG_DIR.mkdir(exist_ok=True)

# Log file named with date for easy identification
LOG_FILE = LOG_DIR / f"det_lab_uber_{datetime.now():%Y%m%d}.log"


# ========== LOGGER CONFIGURATION ==========

logger = logging.getLogger("det_lab_uber")
...
# Log startup
logger.info(f"DET Lab UBER Tool logger initialized. Log file: {LOG_FILE}")
